...
**Stancetrace** - Error lines that give information about the coding errors

**Syntax Error** - Can't recognise files as ruby

**Runtime Error** - Creates stancetraces after executing code
